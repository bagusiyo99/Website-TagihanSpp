                    ...
                    <div class="col-sm-7">
                        <div class="card-body">
                            ...
                            <p class="mb-4">
                                ...
                                Notifikasi Yang belum kamu lihat. Klik Tomboh dibawah untuk melihat informasi Pembayran
                            </p>
            ...
            <div class="col-md-6 col-lg-4 order-2 mb-4">
                <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="card-title m-0 me-2">Kartu Spp {{ $item['siswa']['nama'] }}</h5>
                        <div class="dropdown">
                    ...
                    <div class="card-body">
                        <ul class="p-0 m-0">
                            @foreach ($dataRekap as $itemTagihan)
